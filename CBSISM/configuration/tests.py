...
class EndpointTestCase(TestCase):
    #set up the test cases by building endpoint object for raspberry pi
    def setUp(self):
    ...
    #test that the exporter can be installed on test devices
    ...
    #test tht new endpoint can be added to prometheus as a targer
    ...
    #test tht new endpoint can be removed from prometheus as a targer
